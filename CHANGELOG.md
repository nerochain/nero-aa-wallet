...
- **TST token removed**: Filtered out TST (test token) from both main wallet token list and paymaster selection
- Improved token display to show only relevant tokens to users
